...
//login admin
Route::get('/loginAdmin', [AuthController::class, 'login_admin']);
...
//add favorite
Route::post('/favorite', [FavoriteController::class, 'add_favorite'])->middleware('auth');
//remove favorite
Route::delete('/favorite/{id}', [FavoriteController::class, 'remove_favorite'])->middleware('auth');
//view favorites
Route::get('/favorite', [FavoriteController::class, 'view_favorites']);
